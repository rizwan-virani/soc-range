...
(function () {
  function build() {
    ...
    f.innerHTML =
      '<p style="margin:0 0 12px">This is a personal educational resource. All views, content, and materials presented here are entirely my own and do not represent the official positions, endorsements, or policies of San Jacinto College.</p>' +
      ...
      '<p style="margin:0 0 12px">This site was designed and engineered with development assistance from Anthropic\'s Claude Opus 4.8 large language model.</p>' +
